			...
			<div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
				<div className="mx-auto max-w-5xl text-center">
					...
					<p className="pt-10 mx-auto mt-6 max-w-5xl text-xl leading-8 text-indigo-200 text-left">
						...
						shorter/longer/creative/formal, etc., and give it back
						as an output.
						<br />
						<br />
						...
						INCREDIBLE content that also sits perfectly with Google
						algorithms so that you don’t face any difficulty while
						ranking content through SEO.
					</p>
				</div>
			</div>
		</div>
